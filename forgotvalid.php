...
if($num == 1){
    ...
    $to = $email;
          ...
          $message .= "<h4>Hi $username, </h4><br>";
          $message .= "<h4>Greetings from RoboKalam ! We welcome you aboard the RoboKalam community !</h4>";
          $message .="<h4>Click the button below to set a new password . This is the email address on which your profile will be created</h4>";
          $message .= "<a href='http://localhost/pp/website1.0/forgotvarified.php?vkey=$vkey'>new password</a>";
